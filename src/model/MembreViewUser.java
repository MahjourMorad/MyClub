...
public class MembreViewUser extends JFrame {
	...
	private void initComponents() {
		...
		label2 = new Label();
		jPanel1 = new JPanel();
		jPanel1.setForeground(new Color(255, 250, 240));
		lbl = new JLabel();
		...
		jButton2.setBackground(new Color(250, 240, 230));
		...
		jPanel2Layout.setHorizontalGroup(
			jPanel2Layout.createParallelGroup(Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup()
					.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 1256, GroupLayout.PREFERRED_SIZE)
	...
	private void jButton3ActionPerformed(ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		...
		new MembreIndividualUser().setVisible(true);
		// setVisible(true);
		dispose();

	}// GEN-LAST:event_jButton3ActionPerformed

	private void jTextField1ActionPerformed(ActionEvent evt) {// GEN-FIRSTt_jTextField1ActionPerformed
		// TODO add your handling code here:
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(MembreView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
